.PHONY: help start-openfga stop-openfga status-openfga logs-openfga import-openfga-store start-service stop-service restart-service status-service logs-service test test-dual-write
